...
<section class="min-h-screen bg-black text-white px-4 py-20">
	<h1 class="text-center text-4xl font-bold text-blob mb-10 uppercase tracking-wide">Team News</h1>

	<div class="max-w-3xl mx-auto space-y-6">
		{#each paginated as article}
			<div class="bg-zinc-900 p-6 rounded-lg shadow">
	...
	<div class="mt-10 flex justify-center gap-4 text-sm text-yellow-400">
		<button on:click={() => currentPage--} disabled={currentPage === 1} class="disabled:opacity-30">
			Prev
		</button>
